...
public class Processed_OrderAd extends RecyclerView.Adapter<Processed_OrderAd.MyViewHolder> {
    ...
    public Processed_OrderAd() {
        ...
        mDatabaseRef = mFirebaseDatabase.getReference().child("Processed orders");
    ...
    @NonNull
    @Override
    public Processed_OrderAd.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.deliveries, parent, false);

        return new Processed_OrderAd.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Processed_OrderAd.MyViewHolder holder, int position) {
