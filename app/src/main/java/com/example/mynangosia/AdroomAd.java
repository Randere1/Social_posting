...
public class AdroomAd  extends RecyclerView.Adapter<AdroomAd .MyViewHolder> implements Filterable {
    Context mContext;
    ...
    public  AdroomAd  (Context mContext,ArrayList<roomsGS> discposts){
    ...
    @NonNull
    @Override
    public AdroomAd .MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.room_layout, parent, false);

        return new AdroomAd .MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdroomAd .MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), AdminroomClick.class);
