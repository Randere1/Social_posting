...
public class productClick extends AppCompatActivity {
    ...
    private DatabaseReference users, Product, cart,Total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shoppingCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(productClick.this, myCart.class));
            }
        });
        ...
        Product = FirebaseDatabase.getInstance().getReference().child("Products").child("pk");
                ...
                users.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            String quantity = productClick.this.quantity.getText().toString();
                            ...
                            Toast.makeText(productClick.this, "sum" + totalValue, Toast.LENGTH_SHORT).show();
                            ...
                            cart.child("Carts").child(b).child(discpost.getPk()).updateChildren(picpostmap).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(productClick.this, "all done" + sum, Toast.LENGTH_SHORT).show();
        ...
        subtract.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int finalValue = Integer.parseInt(value);
                if (finalValue == 1) {
                    Toast.makeText(productClick.this, "Quantity can't be less than 1", Toast.LENGTH_SHORT).show();
                } else {
                    finalValue --;
                    String str = Integer.toString(finalValue);
                    quantity.setText(str);
    ...
    private void SendUserToMain() {
        Intent e = new Intent(productClick.this, MainActivity.class);
        startActivity(e);
    }
}
