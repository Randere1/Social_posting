...
public class roomAD  extends RecyclerView.Adapter<roomAD .MyViewHolder> implements Filterable {
    Context mContext;
    ...
    public  roomAD  (Context mContext,ArrayList<roomsGS> discposts){
    ...
    @Override
    public void onBindViewHolder(@NonNull roomAD .MyViewHolder holder, int position) {
