...
public class AdproductAd extends RecyclerView.Adapter<AdproductAd.MyViewHolder> implements Filterable {
    Context mContext;
    ...
    public  AdproductAd (Context mContext,ArrayList<alcoholGs> discposts){
    ...
    @NonNull
    @Override
    public AdproductAd.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.biz_layout, parent, false);

        return new AdproductAd.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdproductAd.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), AdminproductClick.class);
