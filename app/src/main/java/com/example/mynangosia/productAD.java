...
public class productAD extends RecyclerView.Adapter<productAD.MyViewHolder> implements Filterable {
    Context mContext;
    ...
    public  productAD (Context mContext,ArrayList<alcoholGs> discposts){
    ...
    @NonNull
    @Override
    public productAD.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.biz_layout, parent, false);

        return new productAD.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull productAD.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), productClick.class);
