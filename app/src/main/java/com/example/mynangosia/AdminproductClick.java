...
public class AdminproductClick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminproduct_click);
       ...
       reff = FirebaseDatabase.getInstance().getReference().child("Products");
        ...
        d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reff.child(discpost.getPk()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(AdminproductClick.this, "Deleted record succesfuly", Toast.LENGTH_SHORT).show();
                            Intent e=new Intent(AdminproductClick.this,admin.class);
                            startActivity(e);
                        }
                    }
                });
        ...
        c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty( f)) {
                    Toast.makeText(AdminproductClick.this, "please write products name", Toast.LENGTH_LONG).show();
                }
                if (TextUtils.isEmpty(  g)) {
                    Toast.makeText(AdminproductClick.this, "please write price", Toast.LENGTH_LONG).show();
                }
                if (TextUtils.isEmpty(  i)) {
                    Toast.makeText(AdminproductClick.this, "please write drinks description", Toast.LENGTH_LONG).show();
                }else{
                    ...
                    assert  discpost.getPk() != null;
                    reff.child(discpost.getPk()).updateChildren(picpostmap).addOnCompleteListener(new OnCompleteListener() {
                        @Override
                        public void onComplete(@NonNull Task task) {
                            if (task.isSuccessful()){
                                Toast.makeText(AdminproductClick.this, "Data changed succesfuly", Toast.LENGTH_SHORT).show();
                                Intent e=new Intent(AdminproductClick.this,admin.class);
                                startActivity(e);
                            }
                        }
