...
public class my_Undelivered_OrdersAd extends RecyclerView.Adapter<my_Undelivered_OrdersAd.MyViewHolder> {
    ...
    public   my_Undelivered_OrdersAd() {
        ...
        mDatabaseRef = mFirebaseDatabase.getReference().child("Undelivered Orders").child(currentUserId);
    ...
    @NonNull
    @Override
    public my_Undelivered_OrdersAd.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.deliveries, parent, false);

        return new my_Undelivered_OrdersAd.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull my_Undelivered_OrdersAd.MyViewHolder holder, int position) {
